...
use WorldOS\Evolution\Domain\Legacy\Constant\PresetDescriptor;
use WorldOS\Evolution\Domain\Legacy\Mathematics\Vector;
use WorldOS\Evolution\Domain\Legacy\Mathematics\PressureAccumulationField;
use WorldOS\Evolution\Domain\Legacy\Mathematics\CriticalityDetector;
use WorldOS\Evolution\Domain\Legacy\Mathematics\InnovationBurst;
use WorldOS\Evolution\Domain\Legacy\ValueObject\PhaseSignal;

/**
 * Base Physics Engine â€” pure dynamics (differentials, feedback, criticality).
 ...
 *    structural mutation is NOT applied â€” caller uses getLastPhaseSignal() and applies mutation if needed.
 */
class BasePhysicsEngine
{
     ...
     * @param \WorldOS\Evolution\Domain\Legacy\Constant\RegimeModifier|null $regime
     */
    public function evolve(WorldStateVector $current, ?PresetDescriptor $preset = null, ?\WorldOS\Evolution\Domain\Legacy\Constant\RegimeModifier $regime = null): WorldStateVector
    {
    ...
    private function coeff(?PresetDescriptor $preset, ?\WorldOS\Evolution\Domain\Legacy\Constant\RegimeModifier $regime, string $param, float $fallback): float
    {
    ...
    protected function calculateDifferentials(WorldStateVector $s, ?PresetDescriptor $preset = null, ?\WorldOS\Evolution\Domain\Legacy\Constant\RegimeModifier $regime = null): Vector
    {
        $d = [];
     ...
     * structural mutation is NOT applied here â€” caller uses getLastPhaseSignal() and StructuralMutationEngine.
     */
