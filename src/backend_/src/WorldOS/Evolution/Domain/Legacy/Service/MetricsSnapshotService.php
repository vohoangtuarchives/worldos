...
use WorldOS\Evolution\Domain\Legacy\ValueObject\AttractorAggregate;
use WorldOS\Evolution\Domain\Legacy\ValueObject\IndividualMemory;
use WorldOS\Evolution\Domain\Legacy\ValueObject\InteractionMemory;
use WorldOS\Evolution\Domain\Legacy\ValueObject\MetricsSnapshot;
use WorldOS\Evolution\Domain\Legacy\ValueObject\WorldSnapshot;

/**
 * MetricsSnapshotService â€” computes all 18 KPIs from simulation state.
 *
...
{
    // CHS weights
    private const CHS_W1 = 0.25; // (1 - SSI) â€” stability reward
    private const CHS_W2 = 0.20; // DI â€” diversity reward
    private const CHS_W3 = 0.15; // AGR â€” adaptation reward
    private const CHS_W4 = 0.10; // RES â€” rebirth effectiveness
    private const CHS_W5 = 0.15; // ICR â€” concentration penalty
    private const CHS_W6 = 0.15; // CF â€” collapse penalty
    ...
    private function calculateSSI(WorldSnapshot $current, array $trajectory): float
    {
        ...
        // Scale: rate of 0.1/step â‰ˆ SSI of 1.0 (instability threshold)
        return $maxRate * 10.0;
    }
    ...
    /**
     * DI = 1 - Î£(influence_iÂ²) â€” Herfindahl inverse.
     */
    ...
    /**
     * AGR = Î”Adaptation / epoch (stability trend over recent window).
     */
