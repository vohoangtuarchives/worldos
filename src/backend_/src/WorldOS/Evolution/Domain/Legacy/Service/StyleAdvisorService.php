...
use WorldOS\Evolution\Domain\Legacy\ValueObject\UniverseStyleVersion;
use WorldOS\Evolution\Domain\Legacy\ValueObject\WorldSnapshot;

/**
 * StyleAdvisorService â€” the Meta-AI advisor that proposes style changes.
 *
 * From RFC Â§7:
 *   - Analyzes current simulation trajectory
 *   - Proposes style weight adjustments (small Î´)
...
class StyleAdvisorService
{
    ...
    private function generateProposal(array $metrics, UniverseStyleVersion $currentStyle, float $gi): array
    {
        ...
        // Rule 1: Low order dominance â†’ increase order_bias
        ...
        // Rule 2: High fragmentation â†’ reduce chaos_sensitivity
        ...
        // Rule 3: Low arc smoothness â†’ increase emergence_threshold
        ...
        // Rule 4: Low diversity â†’ increase diversity_bias
