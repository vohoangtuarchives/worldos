...
/**
 * IndividualMemory â€” Historical Inertia Vector for a single attractor.
 *
 * From RFC Â§5.1:
 *   H(t+1) = Î»Â·H(t) + EventVector       // Î» âˆˆ [0.97, 0.995]
 *   MemoryBias = Î³Â·H
 *   ||MemoryBias|| â‰¤ 0.25
 *
...
final class IndividualMemory
{
    ...
    // Gamma: memory â†’ bias conversion strength
     ...
     *
     * MemoryBias = Î³Â·H, clamped to ||MemoryBias|| â‰¤ 0.25
     */
