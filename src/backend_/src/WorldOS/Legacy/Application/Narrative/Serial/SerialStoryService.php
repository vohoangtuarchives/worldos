...
namespace WorldOS\Legacy\Application\Narrative\Serial;

use WorldOS\Legacy\Infrastructure\Cosmology\Repositories\CosmologyRepository;
use WorldOS\Legacy\Application\Narrative\Bridge\Contracts\StoryEventExtractorInterface;
use WorldOS\Legacy\Application\Narrative\Bridge\NarrativeToUniverseAdapter;
use WorldOS\Legacy\Application\Narrative\Bridge\StateSerializerForPrompt;
use WorldOS\Legacy\Application\Narrative\Bridge\WorldMutationPolicy;
use WorldOS\Saga\Domain\Narrative\ValueObject\BeatSpec;
use WorldOS\Legacy\Application\Narrative\Services\ChapterCriticService;
use WorldOS\Legacy\Application\Narrative\Services\ConsistencyValidator;
use WorldOS\Legacy\Application\Narrative\Services\LorebookResolver;
use WorldOS\Legacy\Application\Narrative\Memory\NarrativeMemoryService;
use WorldOS\Legacy\Application\Narrative\Planning\BeatPlanner;
use WorldOS\Legacy\Application\Narrative\Planning\ChapterProducer;
use WorldOS\Legacy\Application\Narrative\Planning\LayeredProducer;
use WorldOS\Legacy\Application\Narrative\Services\NarrativeBridge;
use WorldOS\Legacy\Application\Narrative\Serial\Contracts\StructuredSummaryGeneratorInterface;
