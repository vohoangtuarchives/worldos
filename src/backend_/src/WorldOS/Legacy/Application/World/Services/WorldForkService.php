...
class WorldForkService
{
     ...
     * @param \WorldOS\Blueprint\Domain\Legacy\ValueObject\WorldLawProfile|null $newProfile (ADR-0006)
     */
    public function fork(
        World $sourceWorld,
        int $atTick,
        string $newName,
        ?\WorldOS\Blueprint\Domain\Legacy\ValueObject\WorldLawProfile $newProfile = null
    ): World {
