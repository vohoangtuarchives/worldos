...
use WorldOS\Legacy\Application\Cosmology\Evolution\ArcPhase;
...
use WorldOS\Legacy\Application\Cosmology\Evolution\RegimeModifier;
use WorldOS\Legacy\Application\Cosmology\Services\BasePhysicsEngine;
use WorldOS\Legacy\Application\Cosmology\Services\StructuralMutationEngine;
use WorldOS\Legacy\Application\Evolution\Engine\VectorDynamicsEngine;
use WorldOS\Evolution\Domain\Legacy\EvolutionContext;
use WorldOS\Evolution\Domain\Legacy\ValueObject\BranchEvent;
use WorldOS\Legacy\Domain\Material\MaterialWorldBridge;
...
final class WorldEvolutionKernel
{
    ...
    public function tickUniverse(World $world, CosmologyUniverse $universe, ?ShockParams $shock = null): void
    {
        if ($this->basePhysics !== null) {
            ...
            \WorldOS\Evolution\Domain\Legacy\Events\WorldTicked::dispatch($world, $state);
