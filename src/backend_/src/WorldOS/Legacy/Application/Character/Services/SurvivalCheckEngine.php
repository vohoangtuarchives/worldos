...
namespace WorldOS\Legacy\Application\Character\Services;
...
use WorldOS\Society\Character\ValueObject\SurvivalResult as TuzySurvivalResult;
use WorldOS\Society\Character\ValueObject\SurvivalTrend;
