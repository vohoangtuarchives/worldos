...
use WorldOS\Legacy\Domain\Cosmology\ValueObject\SocialClass;
...
class SocialDynamicsService
{
     ...
     * @param CivilizationState $civ
     * @param CosmicState $cosmic
     * @param int $years
     * @return SocialClass[]
     */
    public function evolveClasses(array $currentClasses, CivilizationState $civ, CosmicState $cosmic, int $years): array
    {
        $newClasses = [];
        $totalPowerShift = 0.0;
    ...
    private function calculatePowerChange(SocialClass $class, CivilizationState $civ, CosmicState $cosmic, int $years): float
    {
    ...
    private function calculateContentmentChange(SocialClass $class, CivilizationState $civ, CosmicState $cosmic, int $years): float
    {
        $rate = 0.0005 * $years;
        $change = 0.0;
