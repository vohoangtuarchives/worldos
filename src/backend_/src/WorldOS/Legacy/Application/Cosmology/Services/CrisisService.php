...
class CrisisService
{
    ...
    private function applyCrisisEffect(\WorldOS\Legacy\Application\Cosmology\Entities\Universe $universe, string $type, float $proximityFactor): void
    {
        ...
        $newUniverse = new \WorldOS\Legacy\Application\Cosmology\Entities\Universe(
            $newState,
