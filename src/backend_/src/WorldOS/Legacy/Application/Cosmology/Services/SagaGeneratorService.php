...
{
    private \WorldOS\Legacy\Application\Narrative\Services\NarrativeBridge $narrativeBridge;
    ...
    public function __construct(\WorldOS\Legacy\Application\Narrative\Services\NarrativeBridge $narrativeBridge)
    {
