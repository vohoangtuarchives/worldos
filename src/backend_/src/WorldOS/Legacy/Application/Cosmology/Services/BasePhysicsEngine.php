...
use WorldOS\Legacy\Application\Cosmology\Evolution\PresetDescriptor;
use WorldOS\Legacy\Application\Cosmology\Mathematics\Vector;
use WorldOS\Legacy\Application\Cosmology\Mathematics\PressureAccumulationField;
use WorldOS\Legacy\Application\Cosmology\Mathematics\CriticalityDetector;
use WorldOS\Legacy\Application\Cosmology\Mathematics\InnovationBurst;
...
class BasePhysicsEngine
{
     ...
     * @param \WorldOS\Legacy\Application\Cosmology\Evolution\RegimeModifier|null $regime
     */
    public function evolve(WorldStateVector $current, ?PresetDescriptor $preset = null, ?\WorldOS\Legacy\Application\Cosmology\Evolution\RegimeModifier $regime = null): WorldStateVector
    {
    ...
    private function coeff(?PresetDescriptor $preset, ?\WorldOS\Legacy\Application\Cosmology\Evolution\RegimeModifier $regime, string $param, float $fallback): float
    {
    ...
    protected function calculateDifferentials(WorldStateVector $s, ?PresetDescriptor $preset = null, ?\WorldOS\Legacy\Application\Cosmology\Evolution\RegimeModifier $regime = null): Vector
    {
        $d = [];
