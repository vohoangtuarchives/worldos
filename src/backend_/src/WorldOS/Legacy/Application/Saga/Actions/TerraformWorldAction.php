...
use WorldOS\Legacy\Application\Saga\Services\EntropyPressureService;
use WorldOS\Legacy\Application\Saga\Services\PhysicsMutator;
use WorldOS\Legacy\Application\World\Services\WorldEventLedger;
...
class TerraformWorldAction
{
    public function __construct(
        ...
        protected \WorldOS\Legacy\Application\Narrative\Services\RealityNarrator $narrator
    ) {}
    ...
    public function handle(World $aggressor, World $victim): array
    {
        ...
        $this->eventLedger->record(
            $victim, 
            \WorldOS\Saga\Domain\Legacy\Enums\EpicEventType::TERRAFORM_EVENT->value, 
            $dynamicDescription,
            1.0, // Magnitude
            1.0, // Permanence
            'Public',
