...
namespace WorldOS\Legacy\Domain\Meta\Aggregates;

use WorldOS\Legacy\Domain\Meta\Policies\HomeostasisPolicy;
use WorldOS\Legacy\Domain\Replay\DeterministicRandom;
...
class MetaLayer
{
    ...
    {
        $policy = new \WorldOS\Legacy\Domain\Meta\Policies\ExtinctionPolicy();
    ...
    {
        $policy = new \WorldOS\Legacy\Domain\Meta\Policies\CanonizationPolicy();
