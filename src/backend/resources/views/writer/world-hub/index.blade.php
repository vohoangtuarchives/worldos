        ...
        <div class="min-w-0 flex-1">
            ...
            <div class="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6">
                ...
                <span class="mt-2 flex items-center text-sm text-gray-400 font-mono">
                    Epoch {{ $world->current_epoch }} · Tick {{ $world->current_tick }}
                </span>
                <span class="mt-2 flex items-center text-sm {{ $world->autonomous ? 'text-green-400' : 'text-gray-500' }}">
                    {{ $world->autonomous ? '🤖 Auto' : '🎮 Manual' }}
                </span>
            </div>
        </div>
    </div>
