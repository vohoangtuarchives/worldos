...
use App\Domains\World\Interaction\Presets\PresetInteraction;
...
class HybridPresetGenerator
{
    ...
    private function registerInteractions(): void
    {
        $this->interactionRegistry = [
            'BELIEF_CONTAMINATION' => new \App\Domains\World\Interaction\Presets\FaithRationalInteraction(),
            'RESOURCE_CROSSFLOW' => new \App\Domains\World\Interaction\Presets\PoliticalResourceInteraction(),
            'REALITY_DISTORTION' => new \App\Domains\World\Interaction\Presets\ChaoticStableInteraction()
        ];
    }
