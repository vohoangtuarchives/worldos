...
class BasePhysicsEngine
{
     ...
     * @param \App\Domains\Cosmology\Evolution\RegimeModifier|null $regime
     */
    public function evolve(WorldStateVector $current, ?PresetDescriptor $preset = null, ?\App\Domains\Cosmology\Evolution\RegimeModifier $regime = null): WorldStateVector
    {
    ...
    private function coeff(?PresetDescriptor $preset, ?\App\Domains\Cosmology\Evolution\RegimeModifier $regime, string $param, float $fallback): float
    {
    ...
    protected function calculateDifferentials(WorldStateVector $s, ?PresetDescriptor $preset = null, ?\App\Domains\Cosmology\Evolution\RegimeModifier $regime = null): Vector
    {
        $d = [];
