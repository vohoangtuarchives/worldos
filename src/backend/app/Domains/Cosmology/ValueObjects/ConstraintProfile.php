 ...
 * Maps Author Intent axes to pressure coefficients (α, β, γ, δ) and inertia (λ).
...
final class ConstraintProfile
{
    ...
    // --- Pressure coefficients (0..1). Steep power / high conflict → higher α, etc. ---

    /** α: weight for Power Imbalance in Base Tension */
    ...
    /** γ: weight for Ideology Divergence */
    ...
    /** δ: weight for Social Fragmentation */
    ...
    /** λ: inertia for pressure smoothing. P(t) = λ*P(t-1) + (1-λ)*raw */
    ...
    /** Feedback amplification factor k (BT² term) */
