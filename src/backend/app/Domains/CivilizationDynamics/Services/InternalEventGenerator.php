...
namespace App\Domains\CivilizationDynamics\Services;

use App\Domains\CivilizationDynamics\Entities\CivilizationState;
use App\Domains\WorldEvolution\Entities\WorldState;
use App\Domains\WorldEvolution\Events\WorldEvent;
    ...
    private function createEventFromPressure(string $type, CivilizationState $civ, WorldState $world): WorldEvent
    {
        ...
        return new class($world->sagaId, $world->universeId, $world->currentYear, $type, $civ->name) extends WorldEvent {
            ...
            public function getImpactVector(): array {
                ...
                return [
                    \App\Domains\Cosmology\Entities\WorldStateVector::DIMENSION_ENTROPY => +0.15,
                    \App\Domains\Cosmology\Entities\WorldStateVector::DIMENSION_ORDER => -0.1
                ];
            }
        };
    }
