...
namespace App\Domains\Saga\ValueObjects;

/**
 * Phase 5: Structured abstraction for collapse (for AI input — không gửi raw vector).
 */
final readonly class CollapseProfile
{
