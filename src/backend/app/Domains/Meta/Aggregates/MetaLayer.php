...
namespace App\Domains\Meta\Aggregates;

use App\Domains\Meta\Policies\HomeostasisPolicy;
use App\Domains\Replay\DeterministicRandom;
...
class MetaLayer
{
    ...
    {
        $policy = new \App\Domains\Meta\Policies\ExtinctionPolicy();
    ...
    {
        $policy = new \App\Domains\Meta\Policies\CanonizationPolicy();
