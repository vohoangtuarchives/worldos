...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('legacy_world_states', function (Blueprint $table) {
            $table->uuid('id')->primary();
        ...
        Schema::table('legacy_world_states', function (Blueprint $table) {
            $table->foreign('parent_state_id')->references('id')->on('legacy_world_states')->onDelete('set null');
        });
        ...
        Schema::create('world_state_transitions', function (Blueprint $table) {
            ...
            $table->foreign('from_state_id')->references('id')->on('legacy_world_states');
        ...
        Schema::create('world_state_metrics', function (Blueprint $table) {
            ...
            $table->foreign('world_state_id')->references('id')->on('legacy_world_states')->onDelete('cascade');
        });
    }
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('legacy_world_states');
