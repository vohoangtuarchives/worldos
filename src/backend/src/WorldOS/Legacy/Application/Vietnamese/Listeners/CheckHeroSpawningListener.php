...
use WorldOS\Legacy\Domain\Vietnamese\Models\Hero;
...
class CheckHeroSpawningListener implements ShouldQueue
{
    ...
    public function __construct(
        ...
        private readonly \WorldOS\Legacy\Application\Vietnamese\Factories\HeroFactory $heroFactory
    ) {}
    ...
    private function attemptSpawn($world, array $allowedArchetypes, string $reason, array $dimensions): void
    {
        ...
        if ($seededHero) {
            ...
            $hero = \WorldOS\Legacy\Domain\Vietnamese\Models\Hero::create([
                'world_id' => $world->id,
