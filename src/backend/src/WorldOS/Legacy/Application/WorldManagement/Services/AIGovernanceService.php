...
class AIGovernanceService
{
     ...
     */
    public function logClaims(int $generationId, array $claims, \WorldOS\Legacy\Application\World\Services\WorldLawValidator $validator, \WorldOS\Blueprint\Domain\Legacy\ValueObject\WorldLawProfile $profile): void
    {
        $data = [];
        $now = now();
