...
class BifurcationManager
{
    ...
    public function __construct(
        private ?\WorldOS\Legacy\Domain\Cosmology\Contracts\AttractorRepositoryInterface $attractorRepository = null,
        private ?\WorldOS\Legacy\Application\Cosmology\Services\MorphingEngine $morphEngine = null
    ) {
