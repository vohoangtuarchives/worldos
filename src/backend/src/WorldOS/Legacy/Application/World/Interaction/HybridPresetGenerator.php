...
namespace WorldOS\Legacy\Application\World\Interaction;

use WorldOS\Blueprint\Domain\Legacy\WorldState;
use WorldOS\Legacy\Application\World\Interaction\Presets\PresetInteraction;
...
class HybridPresetGenerator
{
    ...
    private function registerInteractions(): void
    {
        $this->interactionRegistry = [
            'BELIEF_CONTAMINATION' => new \WorldOS\Legacy\Application\World\Interaction\Presets\FaithRationalInteraction(),
            'RESOURCE_CROSSFLOW' => new \WorldOS\Legacy\Application\World\Interaction\Presets\PoliticalResourceInteraction(),
            'REALITY_DISTORTION' => new \WorldOS\Legacy\Application\World\Interaction\Presets\ChaoticStableInteraction()
        ];
    }
