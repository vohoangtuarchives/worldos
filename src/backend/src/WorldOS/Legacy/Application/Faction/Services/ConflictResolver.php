...
namespace WorldOS\Legacy\Application\Faction\Services;
...
class ConflictResolver
{
    public function __construct(
        private \WorldOS\Society\Faction\Policies\CivilWarPolicy $civilWarPolicy,
        private \WorldOS\Legacy\Application\World\Services\WorldEventLedger $ledger
    ) {}
