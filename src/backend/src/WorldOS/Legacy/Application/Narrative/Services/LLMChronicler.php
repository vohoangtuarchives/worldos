...
use WorldOS\Saga\Domain\Narrative\Contracts\ChroniclerInterface;
...
class LLMChronicler implements ChroniclerInterface
{
    ...
    private ?\WorldOS\Legacy\Domain\Genre\GenreRegistry $registry;

    public function __construct(NarrativeBridge $bridge, ?LLMProvider $llm = null, ?\WorldOS\Legacy\Domain\Genre\GenreRegistry $registry = null)
    {
        $this->bridge = $bridge;
        ...
        $this->registry = $registry ?? (app()->bound(\WorldOS\Legacy\Domain\Genre\GenreRegistry::class) ? app(\WorldOS\Legacy\Domain\Genre\GenreRegistry::class) : null);
    }
