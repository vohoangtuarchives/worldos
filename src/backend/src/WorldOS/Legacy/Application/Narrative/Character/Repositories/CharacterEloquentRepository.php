...
namespace WorldOS\Legacy\Application\Narrative\Character\Repositories;

use WorldOS\Legacy\Application\Narrative\Character\Character as CharacterAggregate;
