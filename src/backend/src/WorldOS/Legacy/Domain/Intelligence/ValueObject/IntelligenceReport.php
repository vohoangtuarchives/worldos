...
namespace WorldOS\Legacy\Domain\Intelligence\ValueObject;

use DateTimeInterface;

/**
 * Domain value object for an intelligence report (type, source, content, accuracy, age).
 */
readonly class IntelligenceReport
{
