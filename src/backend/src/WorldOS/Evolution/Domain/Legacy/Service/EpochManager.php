...
/**
 * EpochManager â€” manages epoch lifecycle and style transitions.
 *
 * From RFC Â§6.4:
 *   Epoch { id, world_id, start_tick, end_tick, style_version_id, law_version_id }
 *   Style update â†’ new epoch â†’ dampened transition:
 *     effective_style(t) = lerp(old, new, Î±)  // Î± increases over N ticks
 *
...
class EpochManager
{
     ...
     *
     * effective_style(t) = lerp(old, new, Î±)  where Î± ramps from 0â†’1
     */
