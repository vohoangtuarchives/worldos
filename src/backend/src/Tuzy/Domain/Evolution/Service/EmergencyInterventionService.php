...
/**
 * EmergencyInterventionService â€” god-mode interventions.
 *
...
class EmergencyInterventionService
{
    ...
    // =====================================================================
    // V3 Methods â€” operate on UniverseModel (state_vector JSON)
    // =====================================================================
    ...
    // =====================================================================
    // Legacy Methods â€” operate on WorldSnapshot VO (for WriterConsole compat)
    // =====================================================================
