...
use Tuzy\Domain\Evolution\Mathematics\InnovationBurst;
use Tuzy\Domain\Evolution\ValueObject\PhaseSignal;
...
class BasePhysicsEngine
{
     ...
     * @param \Tuzy\Domain\Evolution\Constant\RegimeModifier|null $regime
     */
    public function evolve(WorldStateVector $current, ?PresetDescriptor $preset = null, ?\Tuzy\Domain\Evolution\Constant\RegimeModifier $regime = null): WorldStateVector
    {
    ...
    private function coeff(?PresetDescriptor $preset, ?\Tuzy\Domain\Evolution\Constant\RegimeModifier $regime, string $param, float $fallback): float
    {
    ...
    protected function calculateDifferentials(WorldStateVector $s, ?PresetDescriptor $preset = null, ?\Tuzy\Domain\Evolution\Constant\RegimeModifier $regime = null): Vector
    {
        $d = [];
