...
use Tuzy\Domain\Evolution\ValueObject\Faction;
use Tuzy\Domain\Evolution\ValueObject\EliteNetwork;
...
final class FactionEvolutionEngine
{
    ...
    private function applyMerge(
        ...
        if ($mergePair !== null && $minDist < 0.6) {
            ...
            $newIdeology = new \Tuzy\Domain\Evolution\ValueObject\IdeologyVector(
