...
use Tuzy\Domain\Evolution\ValueObject\CivilizationResidual;
...
class CivilizationState extends AggregateRoot
{
    ...
    /** @var string[] */
    private array $controlledRegionIds = [];
    ...
    /** @return string[] */
    public function getControlledRegionIds(): array
    {
        return $this->controlledRegionIds;
    }

    public function addControlledRegionId(string $regionId): void
    {
        if (!in_array($regionId, $this->controlledRegionIds)) {
            $this->controlledRegionIds[] = $regionId;
        }
    }

    public function removeControlledRegionId(string $regionId): void
    {
        $this->controlledRegionIds = array_values(array_filter(
            $this->controlledRegionIds,
            fn($id) => $id !== $regionId
        ));
    }
