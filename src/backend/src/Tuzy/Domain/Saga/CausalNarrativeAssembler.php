...
use Tuzy\Application\Saga\Services\NarrativeDictionary;
...
{
    private ?\Tuzy\Application\Saga\Author\AuthorPersona $persona = null;
    ...
    public function setPersona(\Tuzy\Application\Saga\Author\AuthorPersona $persona): void
    {
