...
use Tuzy\Domain\Material\ValueObject\SurvivalProbability;
use Tuzy\Domain\Material\ValueObject\RiskFactors;
use Tuzy\Domain\Material\ValueObject\NarrativeWeight;
