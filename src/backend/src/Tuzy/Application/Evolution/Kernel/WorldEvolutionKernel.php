...
use Tuzy\Application\Cosmology\Evolution\ArcPhase;
use Tuzy\Domain\Saga\ValueObject\ShockParams;
use Tuzy\Application\Cosmology\Evolution\PresetDescriptor;
use Tuzy\Application\Cosmology\Evolution\RegimeModifier;
...
final class WorldEvolutionKernel
{
    ...
    public function tickUniverse(World $world, CosmologyUniverse $universe, ?ShockParams $shock = null): void
    {
        if ($this->basePhysics !== null) {
            ...
            \Tuzy\Domain\Evolution\Events\WorldTicked::dispatch($world, $state);
