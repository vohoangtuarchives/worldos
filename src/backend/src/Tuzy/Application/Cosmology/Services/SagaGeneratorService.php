...
{
    private \Tuzy\Application\Narrative\Services\NarrativeBridge $narrativeBridge;
    ...
    public function __construct(\Tuzy\Application\Narrative\Services\NarrativeBridge $narrativeBridge)
    {
