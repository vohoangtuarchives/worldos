...
class BifurcationManager
{
    ...
    public function __construct(
        private ?\Tuzy\Domain\Cosmology\Contracts\AttractorRepositoryInterface $attractorRepository = null,
        private ?\Tuzy\Application\Cosmology\Services\MorphingEngine $morphEngine = null
    ) {
