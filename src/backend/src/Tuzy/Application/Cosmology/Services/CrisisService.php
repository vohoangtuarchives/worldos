...
class CrisisService
{
    ...
    private function applyCrisisEffect(\Tuzy\Application\Cosmology\Entities\Universe $universe, string $type, float $proximityFactor): void
    {
        ...
        $newUniverse = new \Tuzy\Application\Cosmology\Entities\Universe(
            $newState,
