...
use Tuzy\Infrastructure\Power\Repositories\WorldEventLedgerRepository;
use Tuzy\Domain\Power\PowerStageRegistry;
use Tuzy\Domain\World\Policies\ContradictionPolicyResolver;
use Tuzy\Application\World\Memory\ContradictionMemoryRepository;
