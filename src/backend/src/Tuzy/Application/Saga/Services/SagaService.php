...
use Tuzy\Application\Runtime\Evaluation\DecisionEngine;
...
class SagaService
{
    ...
    public function spawnUniverseFromPreset(World $world, string $presetKey): Universe
    {
        ...
        if (!empty($preset)) {
            ...
            app(\Tuzy\Application\World\Services\WorldPowerProfileService::class)->bootstrapProfile($world, $preset);
        }
