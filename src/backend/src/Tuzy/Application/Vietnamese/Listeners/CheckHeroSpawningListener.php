...
namespace Tuzy\Application\Vietnamese\Listeners;

use Tuzy\Domain\Evolution\Events\WorldTicked;
use Tuzy\Application\Vietnamese\Services\HeroMaterialBridge;
use Tuzy\Domain\Vietnamese\Models\VietnameseHero; 
use Tuzy\Domain\Vietnamese\Models\WorldHero;
...
class CheckHeroSpawningListener implements ShouldQueue
{
    ...
    public function __construct(
        ...
        private readonly \Tuzy\Application\Vietnamese\Factories\HeroFactory $heroFactory
    ) {}
    ...
    private function attemptSpawn($world, array $allowedArchetypes, string $reason, array $dimensions): void
    {
        ...
        if ($seededHero) {
            ...
            $hero = \Tuzy\Domain\Vietnamese\Models\WorldHero::create([
                'world_id' => $world->id,
