...
class AIGovernanceService
{
     ...
     */
    public function logClaims(int $generationId, array $claims, \Tuzy\Application\World\Services\WorldLawValidator $validator, \Tuzy\Domain\World\ValueObject\WorldLawProfile $profile): void
    {
        $data = [];
        $now = now();
