...
use Tuzy\Domain\Genre\Contracts\MaterialSystem;
use Tuzy\Domain\Genre\Contracts\ProgressionRule;
...
use Tuzy\Application\Genre\Validation\XianxiaGenreValidator;
