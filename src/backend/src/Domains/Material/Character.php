...
use WorldOS\Domains\Material\ValueObjects\SurvivalProbability;
use WorldOS\Domains\Material\ValueObjects\RiskFactors;
use WorldOS\Domains\Material\ValueObjects\NarrativeWeight;
