...
use WorldOS\Domains\Evolution\ValueObjects\ConstraintProfile;

/**
 * Criticality Detector â€” TÃ­nh toÃ¡n khi nÃ o Ä‘áº¡t Ä‘iá»ƒm chuyá»ƒn pha (phase transition)
 *
 * Supports 3 zones: Stability (<0.4), Metastable (0.4â€“0.75), Critical (â‰¥0.75).
...
class CriticalityDetector
{
    ...
    /** Collapse trigger: contradiction > X AND innovation < Y AND resource_flow < Z â†’ structural fracture */
    ...
    public function assess(
        ...
        // Collapse Function (Ä‘áº¡o ráº¡n ná»©t): explicit phase transition trigger
        $collapseCondition = $this->collapseTrigger($s);

        $shouldCollapse = $collapseCondition || $pressure > 0.9;

        // Reorganization possible: entropy cao, innovation chÆ°a quÃ¡ tháº¥p
