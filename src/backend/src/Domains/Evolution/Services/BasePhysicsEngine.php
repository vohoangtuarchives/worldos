...
use WorldOS\Domains\Evolution\EvolutionConstants\PresetDescriptor;
use WorldOS\Domains\Evolution\Mathematics\Vector;
use WorldOS\Domains\Evolution\Mathematics\PressureAccumulationField;
use WorldOS\Domains\Evolution\Mathematics\CriticalityDetector;
use WorldOS\Domains\Evolution\Mathematics\InnovationBurst;
...
class BasePhysicsEngine
{
     ...
     * @param \WorldOS\Domains\Evolution\EvolutionConstants\RegimeModifier|null $regime
     */
    public function evolve(WorldStateVector $current, ?PresetDescriptor $preset = null, ?\WorldOS\Domains\Evolution\EvolutionConstants\RegimeModifier $regime = null): WorldStateVector
    {
    ...
    private function coeff(?PresetDescriptor $preset, ?\WorldOS\Domains\Evolution\EvolutionConstants\RegimeModifier $regime, string $param, float $fallback): float
    {
    ...
    protected function calculateDifferentials(WorldStateVector $s, ?PresetDescriptor $preset = null, ?\WorldOS\Domains\Evolution\EvolutionConstants\RegimeModifier $regime = null): Vector
    {
        $d = [];
