...
use WorldOS\Domains\Evolution\ValueObjects\WorldField;
...
class HistoryStateMachine
{
    ...
    public function determineLifecycleState(CivilizationSnapshot $civ): CivilizationLifecycleState
    {
        ...
        // If resilience is gone and state is chaotic/unstable, it's over.
        if ($civ->resilience <= 0.001 && ($civ->stability <= 0.01 || $civ->internalEntropy >= 0.999)) {
