...
use WorldOS\Domains\Evolution\Anchors\StructuralAnchorRegistry;
use WorldOS\Domains\Evolution\Contracts\StructuralAnchorInterface;
use WorldOS\Domains\Evolution\ValueObjects\ConstraintProfile;
use App\Domains\Saga\Services\GenesisPresetService;

/**
 * Maps preset_key â†’ (Structural Anchor + ConstraintProfile).
 * Single source for Khai ThiÃªn and Civilization Forge.
 */
