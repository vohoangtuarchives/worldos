...
use WorldOS\Domains\Evolution\Events\EntropyCriticalReached;
...
use WorldOS\Domains\Evolution\ValueObjects\LifeState;
...
class WorldState extends AggregateRoot
{
    ...
    public function updateFromSnapshot(\WorldOS\Domains\Evolution\ValueObjects\WorldSnapshot $snapshot): void
    {
        ...
        if ($this->cosmicState->entropy >= \WorldOS\Domains\Evolution\EvolutionConstants\PresetDescriptor::default()->get('critical_entropy_threshold', 0.85)) {
