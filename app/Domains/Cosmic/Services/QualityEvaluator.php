 ...
 *   D₆: Archetype Distribution Entropy
 *   D₇: Myth Arc Coherence
 *   D₈: Semantic Contrast
 *
...
class QualityEvaluator
{
    ...
    private function arcSmoothness(array $trajectory): float
    {
        ...
        // Lower variance → higher smoothness (invert and normalize)
    ...
    /**
     * Entropy of archetype distribution (target: 0.6-0.8 — diversity without chaos).
     */
    ...
    private function mythArcCoherence(array $trajectory): float
    {
        ...
        for ($i = 1; $i < count($trajectory); $i++) {
            ...
            // Coherent when high energy → high stability (same direction)
